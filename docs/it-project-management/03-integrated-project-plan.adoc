...
* As you proceed through the PMLC, the information you present about work effortLolInternetLONGER THAN 80
and cost estimates becomes more detailed (especially in the WBS)Fixme btw   
